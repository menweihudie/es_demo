...
namespace Zhaoxi.ElasticSearchCore.ES
{
    ...
    //{
    //    public static readonly IList<ISort> ByDocumentOrder = new ReadOnlyCollection<ISort>(new List<ISort>
    //    {
    //        new SortField
    //        {
    //            Field = "_doc"
    ...
    //    public bool? IgnoreUnmappedFields
    //    {
    //        get;
    //        set;
    //    }
        ...
        where T : class
    {
        ...
        public override QueryContainer GetQuery(QueryContainer query)
        {
            switch (ExpressOperator)
            {
                ...
                default:
                    throw new Exception("构建Elasticsearch查询谓词异常");
            }
            return query;
        }
    }
